...
const SearchBox = ({ }: SearchBoxProps) => {
  ...
  return (
    <div className="md:flex md:items-center bg-white md:rounded-full rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-200">
